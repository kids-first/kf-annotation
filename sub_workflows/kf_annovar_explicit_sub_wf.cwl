...
outputs:
  ANNOVAR_refGene: 
    type: File[]
    outputSource: [annovar_refgene/anno_vcf, annovar_refgene/anno_tbi, annovar_refgene/anno_txt]
  ANNOVAR_ensGene: 
    type: File[]
    outputSource: [annovar_ensgene/anno_vcf, annovar_ensgene/anno_tbi, annovar_ensgene/anno_txt]
  ANNOVAR_knownGene:
    type: File[]
    outputSource: [annovar_knowngene/anno_vcf, annovar_knowngene/anno_tbi, annovar_knowngene/anno_txt]
